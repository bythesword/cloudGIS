...
import { PoiIMG, ImageContentJSON } from "../../module/sjh/POI/POIIMG"
import { Destination, StatusOfObjectString, ObjectStatus } from "../../module/common/baseConfig"
...
import { ObjectContentJSON } from "../../module/common/poiBase";
...
onMounted(() => {
    ...
    let one: ObjectStatus<ImageContentJSON> = {
    ...
    let poiImageOne: ObjectContentJSON<ImageContentJSON> = {
        obj: one,
        type: "image"
    }
    let poiImage1 = new PoiIMG(
        {
            coord: [116.396, 39.811, 60],
            viewer: viewer,
        }
    )

    poiImage1.loadFromJSON(poiImageOne);

    window.main = poiImage1;
