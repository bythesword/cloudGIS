...
import { TestBall } from "../../module/sjh/testBall";
...
onMounted(() => {
    ...
    window.Viewer.camera.setView({
        destination: Cesium.Cartesian3.fromDegrees(116.396, 39.811, 2500),
        orientation: {
            heading: Cesium.Math.toRadians(0.0),
            pitch: Cesium.Math.toRadians(-90.0),
        }
    });
    let ball = new TestBall({ coord: [116.3915382409668, 39.8085, 2000], viewer: window.Viewer });
    console.log(ball)
});
</script>