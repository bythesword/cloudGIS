...
import * as rgbaJSON from "../../public/zts/zts.json";
...
viewer.camera.setView({
    destination: Cesium.Cartesian3.fromDegrees(lang, lat, 5000),
    orientation: {
...
var origin = Cesium.Cartesian3.fromDegrees(lang, lat, 5)
